...
bikinirepair.createElement = function (id) {
...
TraceKit.report.subscribe(function yourLogger(errorReport) {
    if (errorReport.stack != null) {
        for (let i = 0; i < errorReport.stack.length; i++) {
            const stack = errorReport.stack[i];
            let fileName = "?";
            if (stack.url != null) {
                fileName = stack.url;
            }
            stack.file = fileName;
            if (errorReport.file == null) {
                errorReport.file = fileName;
                errorReport.line = stack.line;
                errorReport.column = stack.column;
            }
        }
    }
