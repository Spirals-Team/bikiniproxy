...
bikiniproxy.loadFile = function (name, url, hash, pageId) {
    ajax.json("http://localhost:8080/api/file", {
        name: name,
        url: url,
        hash: hash,
        pageId: pageId,
...
bikiniproxy.logException = function (msg, url, lineNo, columnNo, e) {
    var jError = {};
    if (e != null) {
        jError.name = e.name;
        jError.fileName = e.fileName;
        jError.lineNumber = e.lineNumber;
        jError.columnNumber = e.columnNumber;
        jError.stack = e.stack;
        jError.message = e.message;
    }
    ajax.json("http://localhost:8080/api/exception", {
        message: msg,
        url: url,
        line: lineNo,
        column: columnNo,
...
window.onerror = function (msg, url, lineNo, columnNo, error) {
    ...
    bikiniproxy.logException(msg, url, lineNo, columnNo, error);
};;/**
