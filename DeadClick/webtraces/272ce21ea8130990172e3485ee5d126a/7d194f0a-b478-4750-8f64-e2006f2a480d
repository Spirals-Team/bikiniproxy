...
define(function () {
    ...
    var env_deploy_addHostNew = 'https://www.nytimes.com/svc/collections/v1/publish/www.nytimes.com/';
    var env_deploy_realestateHost = 'https://service-nytimes.gabriels.net';
    var env_deploy_realestateBasicSearchHost = 'https://static-nytimes-production-gabriels.akamaized.net/JSONSuggestService.aspx';
    var env_deploy_realestateSmartSearchHost = 'https://service-nytimes.gabriels.net/v1.1/SmartSearchResults.aspx';
    var env_deploy_realestateResultsHost = 'http://realestate.nytimes.com';
    var env_deploy_realestatePostAdLinkHost = 'https://nytimesads.gtspayments.com/';
    var env_deploy_realestateJsonHost = 'https://nyt-services.gabriels.net';
    var env_deploy_realestateGtsHost = 'https://gts-nytimes.akamaized.net';
    var env_deploy_realestateSimilarListingsHost = 'https://nyt-services.gabriels.net/Listings/v1.0/NYT.Listings.svc/getSimilarListings';
    ...
    var env_deploy_recommendationApiHost = 'https://rec.api.nytimes.com';
    var env_deploy_smsGateway = 'https://www.nytimes.com';
    var env_deploy_emailApiHost = 'https://mes.api.nytimes.com';
    ...
    var env_fabrikConnectHost = 'wss://core.fabrik.nytimes.com';
    ...
    var env_messagingHost = 'https://messaging-notifications.api.nytimes.com';
    ...
    var env_tagxHost = 'https://tagx.nytimes.com';
    ...
    var env_weatherApiHost = 'https://content.api.nytimes.com';
    var env_personalizationAppspotHost = 'https://nyt-per-prd.appspot.com';
    var env_contentApiHost = 'https://content.api.nytimes.com';
    var env_static01Host = 'https://static01.nytimes.com';
    ...
    return {
        ...
        DUHost: env_DUHost,
        fabrikConnectHost: env_fabrikConnectHost,
        ...
        tagxHost: env_tagxHost,
        tokenHost: env_tokenHost,
        userInfoHost: env_userInfoHost,
        videoApiHost: env_videoApiHost,
        weatherApiHost: env_weatherApiHost,
        personalizationAppspotHost: env_personalizationAppspotHost,
        contentApiHost: env_contentApiHost,
        static01Host: env_static01Host,
        ...
        realestateGtsHost: env_deploy_realestateGtsHost,
        ...
        recommendationApiHost: env_deploy_recommendationApiHost,
        smsGatewayHost: env_deploy_smsGateway,
        emailApiHost: env_deploy_emailApiHost
    };
});
