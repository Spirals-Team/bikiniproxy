...
jQuery(img).attr('src',logo_image_url);
jQuery(logo_div).append(img);
jQuery(logo_div).attr("class","huge_it_" + logo_pos);
jQuery(img).width(logo_width);
logo_opacity = logo_opacity * 0.01;
jQuery(logo_div).css("opacity",logo_opacity);
//alert(logo_pos);
jQuery(document).ready(function(){console.log(logo_show);
if(logo_show == true){
